        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('assets/logo/logo.png') }}" alt="Logo" style="height: 70px; width: auto;">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('admin.shop_items.index')">
                                {{ __('Shop Items') }}
                            </x-dropdown-link>
                    ...
                    <!-- <x-nav-link :href="route('admin.shop_items.index')" :active="request()->routeIs('admin.shop_items.index')">
                        {{ __('Shop Items') }}
                    </x-nav-link> -->
                </div>
            </div>
